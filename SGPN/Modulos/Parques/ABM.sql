...
CREATE OR ALTER PROCEDURE sgpn.sp_leer_region
    @id INT = NULL,
...
CREATE OR ALTER PROCEDURE sgpn.sp_crear_region
    @nombre VARCHAR(100)
AS
BEGIN
    ...
    INSERT INTO sgpn.Region (nombre)
    VALUES (@nombre);
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_modificar_region
    @id INT,
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.Region WHERE id = @id)
...
CREATE OR ALTER PROCEDURE sgpn.sp_eliminar_region
    @id INT
AS
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM sgpn.Provincia WHERE id_region = @id)
        SET @msj_errores += '- No se puede eliminar la Region porque tiene provincias asociadas. ';

    IF EXISTS (SELECT 1 FROM sgpn.EstadisticaVisitantes WHERE id_region = @id)
...
CREATE OR ALTER PROCEDURE sgpn.sp_leer_provincia
    @id INT = NULL,
    @id_region INT = NULL
AS
BEGIN
...
CREATE OR ALTER PROCEDURE sgpn.sp_crear_provincia
    @nombre VARCHAR(100),
    @id_region INT
AS
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.Region WHERE id = @id_region)
    ...
    INSERT INTO sgpn.Provincia (nombre, id_region)
    VALUES (@nombre, @id_region);
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_modificar_provincia
    @id INT,
    @nombre VARCHAR(100) = NULL,
    @id_region INT = NULL
AS
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.Provincia WHERE id = @id)
...
CREATE OR ALTER PROCEDURE sgpn.sp_eliminar_provincia
    @id INT
AS
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM sgpn.ProvinciaParque WHERE id_provincia = @id)
    ...
    DELETE FROM sgpn.Provincia
    WHERE id = @id;
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_eliminar_provincias_de_region
    @id_region INT
AS
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.Provincia WHERE id_region = @id_region)
    ...
    IF EXISTS (
        SELECT 1 
        FROM sgpn.ProvinciaParque PP join sgpn.Provincia P on PP.id_parque = P.id
...
CREATE OR ALTER PROCEDURE sgpn.sp_leer_tipo_visitante
    @id INT = NULL
AS
BEGIN
    ...
    SELECT
        ...
        nombre,
        descripcion
    FROM sgpn.TipoVisitante
    WHERE (@id IS NULL OR id = @id)
    ORDER BY id;
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_crear_tipo_visitante
    @nombre VARCHAR(100),
...
BEGIN
    ...
    INSERT INTO sgpn.TipoVisitante (nombre, descripcion)
    VALUES (@nombre, @descripcion);
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_modificar_tipo_visitante
    @id INT,
    @nombre VARCHAR(100) = NULL,
    @descripcion VARCHAR(255) = NULL
AS
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.TipoVisitante WHERE id = @id)
...
CREATE OR ALTER PROCEDURE sgpn.sp_eliminar_tipo_visitante
    @id INT
AS
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM sgpn.ParqueTipoVisitante WHERE id_tipo_visitante = @id)
    ...
    DELETE FROM sgpn.TipoVisitante
    WHERE id = @id;
END;
GO
...
CREATE OR ALTER PROCEDURE sgpn.sp_leer_tipo_parque
    @id INT = NULL
AS
BEGIN
    ...
    SELECT
        id,
        descripcion
    FROM sgpn.TipoParque
    WHERE (@id IS NULL OR id = @id)
    ORDER BY id;
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_crear_tipo_parque
...
BEGIN
    ...
    INSERT INTO sgpn.TipoParque (descripcion)
    VALUES (@descripcion);
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_modificar_tipo_parque
    @id INT,
    @descripcion VARCHAR(255)
AS
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.TipoParque WHERE id = @id)
    ...
    UPDATE sgpn.TipoParque
    SET descripcion = @descripcion
    WHERE id = @id;
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_eliminar_tipo_parque
    @id INT
AS
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM sgpn.Parque WHERE id_tipo_parque = @id)
...
CREATE OR ALTER PROCEDURE sgpn.sp_leer_parque
    @id INT = NULL,
...
CREATE OR ALTER PROCEDURE sgpn.sp_crear_parque
    @nombre VARCHAR(100),
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.TipoParque WHERE id = @id_tipo_parque)
    ...
    INSERT INTO sgpn.Parque (nombre, superficie_km2, latitud, longitud, id_tipo_parque)
    VALUES (@nombre, @superficie_km2, @latitud, @longitud, @id_tipo_parque);
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_modificar_parque
    @id INT,
    @nombre VARCHAR(100) = NULL,
    @superficie_km2 DECIMAL(10,2) = NULL,
    @latitud DECIMAL(9,6) = NULL,
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.Parque WHERE id = @id)
    ...
    SET nombre = COALESCE(@nombre,nombre),
        ...
        id_tipo_parque = COALESCE(@id_tipo_parque, id_tìpo_parque)
    WHERE id = @id;
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_eliminar_parque
    @id INT
AS
BEGIN
    ...
    --IF EXISTS (SELECT 1 FROM sgpn.ProvinciaParque WHERE id_parque = @id)
    --    SET @msj_errores += '- No se puede eliminar el Parque porque tiene provincias asociadas. ';

    --IF EXISTS (SELECT 1 FROM sgpn.ParqueTipoVisitante WHERE id_parque = @id)
...
CREATE OR ALTER PROCEDURE sgpn.sp_leer_estadistica_visitantes
    @id INT = NULL
AS
BEGIN
    ...
    SELECT
        ...
        cantidad,
        id_region
    FROM sgpn.EstadisticaVisitantes
    WHERE (@id IS NULL OR id = @id)
    ORDER BY id;
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_crear_estadistica_visitantes
    @periodo VARCHAR(50),
...
BEGIN
    ...
    INSERT INTO sgpn.EstadisticaVisitantes (periodo, periodo_inicio, periodo_fin, cantidad, id_region)
    VALUES (@periodo, @periodo_inicio, @periodo_fin, @cantidad, @id_region);
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_modificar_estadistica_visitantes
    @id INT,
    @periodo VARCHAR(50),
    @periodo_inicio DATETIME,
    @periodo_fin DATETIME,
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.EstadisticaVisitantes WHERE id = @id)
    ...
    UPDATE sgpn.EstadisticaVisitantes
    SET periodo = @periodo,
...
CREATE OR ALTER PROCEDURE sgpn.sp_eliminar_estadistica_visitantes
    @id INT
AS
BEGIN
    ...
    DELETE FROM sgpn.EstadisticaVisitantes
    WHERE id = @id;
END;
GO
...
CREATE OR ALTER PROCEDURE sgpn.sp_leer_provincia_parque
...
CREATE OR ALTER PROCEDURE sgpn.sp_crear_provincia_parque
    @id_provincia INT,
    @id_parque INT,
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.Provincia WHERE id = @id_provincia)
    ...
    IF EXISTS (SELECT 1 FROM sgpn.ProvinciaParque WHERE id_provincia = @id_provincia AND id_parque = @id_parque)
    ...
    INSERT INTO sgpn.ProvinciaParque (id_provincia, id_parque, direccion)
    VALUES (@id_provincia, @id_parque, @direccion);
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_modificar_provincia_parque
    @id_provincia INT,
    @id_parque INT,
    @direccion VARCHAR(255) = NULL
AS
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.ProvinciaParque WHERE id_provincia = @id_provincia AND id_parque = @id_parque)
    BEGIN
        RAISERROR('La relacion ProvinciaParque con los IDs provistos no existe.', 16, 1);
        RETURN;
    END;

    UPDATE sgpn.ProvinciaParque
...
CREATE OR ALTER PROCEDURE sgpn.sp_eliminar_provincia_parque
    @id_provincia INT,
    @id_parque INT
AS
BEGIN
    ...
    DELETE FROM sgpn.ProvinciaParque
    WHERE id_provincia = @id_provincia
      AND id_parque = @id_parque;
END;
GO
...
CREATE OR ALTER PROCEDURE sgpn.sp_leer_parque_tipo_visitante
    @id_parque INT = NULL,
...
CREATE OR ALTER PROCEDURE sgpn.sp_crear_parque_tipo_visitante
    @id_parque INT,
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.TipoVisitante WHERE id = @id_tipo_visitante)
    ...
    IF EXISTS (SELECT 1 FROM sgpn.ParqueTipoVisitante WHERE id_parque = @id_parque AND id_tipo_visitante = @id_tipo_visitante)
    ...
    INSERT INTO sgpn.ParqueTipoVisitante (id_parque, id_tipo_visitante, precio)
    VALUES (@id_parque, @id_tipo_visitante, @precio);
END;
GO

CREATE OR ALTER PROCEDURE sgpn.sp_modificar_parque_tipo_visitante
    @id_parque INT,
    @id_tipo_visitante INT,
    @precio DECIMAL(10,2)
AS
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM sgpn.ParqueTipoVisitante WHERE id_parque = @id_parque AND id_tipo_visitante = @id_tipo_visitante)
    ...
    UPDATE sgpn.ParqueTipoVisitante
    SET precio = @precio
...
CREATE OR ALTER PROCEDURE sgpn.sp_eliminar_parque_tipo_visitante
    @id_parque INT,
    @id_tipo_visitante INT
AS
BEGIN
    ...
    DELETE FROM sgpn.ParqueTipoVisitante
    WHERE id_parque = @id_parque
      AND id_tipo_visitante = @id_tipo_visitante;
END;
GO
