...
-- Al esquema seguridad, solo tendran acceso los usuarios con permisos para ver los datos descifrados y quienes los carguen
CREATE OR ALTER FUNCTION seguridad.fn_obtener_pass()
RETURNS VARCHAR(30)
WITH ENCRYPTION -- para que el contenido de la funcion se ofusque
AS
BEGIN
    RETURN 'Cl@veUltraSectreta.'; 
END;
GO
